...
use AssoB2GBundle\Entity\Membre;
use AssoB2GBundle\Form\MembreType;
...
class MembreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AssoB2GBundle:Membre')->findAll();

        return $this->render('AssoB2GBundle:Membre:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AssoB2GBundle:Membre:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AssoB2GBundle:Membre')->find($id);
        ...
        return $this->render('AssoB2GBundle:Membre:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AssoB2GBundle:Membre:edit.html.twig', array(
            'entity'      => $entity,
