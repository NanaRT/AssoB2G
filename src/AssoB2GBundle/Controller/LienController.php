...
use AssoB2GBundle\Entity\Lien;
use AssoB2GBundle\Form\LienType;
...
class LienController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AssoB2GBundle:Lien')->findAll();

        return $this->render('AssoB2GBundle:Lien:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AssoB2GBundle:Lien:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AssoB2GBundle:Lien')->find($id);
        ...
        return $this->render('AssoB2GBundle:Lien:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AssoB2GBundle:Lien:edit.html.twig', array(
            'entity'      => $entity,
