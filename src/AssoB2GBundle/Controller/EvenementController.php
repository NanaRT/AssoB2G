...
use AssoB2GBundle\Entity\Evenement;
use AssoB2GBundle\Form\EvenementType;
...
class EvenementController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AssoB2GBundle:Evenement:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('AssoB2GBundle:Evenement:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AssoB2GBundle:Evenement')->find($id);
        ...
        return $this->render('AssoB2GBundle:Evenement:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('AssoB2GBundle:Evenement:edit.html.twig', array(
            'entity'      => $entity,
